...
<div class="row footer-1">
	...
	<div class="row">
          <div class="col-md-4 col-sm-6 pl-1">
              <div class="row"><h4 class="footer-header">Rumi Optical</h4></div>
              <div class="row"> <p class="footer-paragraph">We have an optical store in Vancouver, located in Downtown Vancouver & Vancouver West End. Rumi Optical is dedicated to providing the best quality, value and service. Our Optometrists in Vancouver can answer your vision and health problems. </p>
          ...
          <div class="col-md-3 col-sm-6 pl-1">
              <div class="row"><h4 class="footer-header">Shop</h4></div>
              <div class="row">
              <ul class="list-unstyled">
                          <li><a href="#">Women Eyeglasses</a></li>
                          <li><a href="#">Men Eyeglasses</a></li>
         ...
         <div class="row"><h4 class="footer-header">Tips & Guides</h4></div>
              <div class="row">
                            <ul class="list-unstyled">
                          <li><a href="#">Fit & Style Eyewear Quiz</a></li>
                          <li><a href="#">How to Buy Glasses Online</a></li>
