  ...
  <nav class="navbar navbar-expand-lg navbar-light sticky-top shadow-sm navbar-main">
    <div class="container-fluid px-6">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggler" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
              aria-haspopup="true" aria-expanded="false">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <a href="www.google.com" class="card card-thumbnails">
                      <div class="card-body">
                        <img src="https://res.cloudinary.com/eyebuydirect-inc/image/upload/c_fill,e_sharpen:70,f_auto,h_350,q_auto:good,w_700/v1/product/frame/gray/pl6631_3.jpg"
