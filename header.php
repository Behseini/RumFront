...
<span class="navbar-toggler-icon"></span>
  ...
  <input type="text" class="form-control" aria-label="" placeholder="Your Email">
...
<div class="dropdown-menu dropdown-menu-right p-0" aria-labelledby="navbarDropdown">
        ...
        <div class="dropdown-box">
            ...
            <ul class="nav nav-pills d-" id="pills-tab" role="tablist">
                <li class="nav-item">
        ...
        <form id="form3" autocomplete="off">
            <div class="form-wrapper">
                ...
                <div class="input-group">
                    ...
                    <input type="password" class="form-control" aria-label="" placeholder="Your Pass" data-dj-validator="word,4,8" autocomplete="new-password" required/>
                    <div class="input-group-append">
